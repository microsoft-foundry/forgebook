...
output deployedAccountName string = aiAccount.outputs.accountName
output accountId string = aiAccount.outputs.accountID
output deployedProjectName string = aiProject.outputs.projectName
output projectId string = aiProject.outputs.projectId
output projectPrincipalId string = aiProject.outputs.projectPrincipalId
output searchName string = aiDependencies.outputs.aiSearchName
output storageName string = aiDependencies.outputs.azureStorageName
output cosmosName string = aiDependencies.outputs.cosmosDBName
