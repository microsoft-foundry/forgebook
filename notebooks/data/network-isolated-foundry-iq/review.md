...
- **Required:** upstream integration must inspect the rendered Mermaid diagram, notebook/helper downloads and raw Markdown route. No browser/site check was performed in this factory worktree.
