...
└── .github/workflows/   # CI: deploy, preview, update-popular
```
...
### Popular Notebooks
- `site/src/data/popular.json` is auto-generated by CI (daily cron via App Insights click data)
- **Never edit popular.json manually** — it gets overwritten
